...
void PoseGraph::addKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop) {
  // Timer::start("PoseGraph:add_keyframe");
  // shift to base frame
  Vector3d vio_P_cur;
  Matrix3d vio_R_cur;
  ...
  // Timer::stop("PoseGraph:add_keyframe");
  // Timer::printTimers();
  publish();
...
int PoseGraph::detectLoop(KeyFrame* keyframe, int frame_index) {
  // Timer::start("PoseGraph:detect_loop");
  ...
  */
  // Timer::stop("PoseGraph:detect_loop");
...
void PoseGraph::loadPoseGraph() {
  ...
  if (pFile == NULL) {
    printf("lode previous pose graph error: wrong previous pose graph path or no previous pose "
